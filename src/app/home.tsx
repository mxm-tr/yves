...
export default function Home() {
  ...
  const confirmedAppointments = Array.isArray(appointments)? appointments.filter(appointment => appointment.confirmed): [];
  const unconfirmedAppointments = Array.isArray(appointments)? appointments.filter(appointment => !appointment.confirmed): [];
